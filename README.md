# 🌄 VFarer 
#### 👨🏻‍💻Team-Members:  [Harsh Vardhan Singh](https://github.com/harshvardhansb) , [Rishu Bajpai](https://github.com/rishubajpai007) , [Sarthak Tomar](https://github.com/SoulKing365)
...
## <a name="introduction">🤖 VFarer</a>


V Farer is a cutting-edge social media application tailored for trekkers and travelers. Leveraging a robust tech stack including React.js, Appwrite, and Tailwind CSS, V Farer provides an immersive platform for adventurers to connect, share experiences, and explore new destinations. Key features include a secure authentication system, an engaging explore page, like and save functionalities, detailed post pages, user profiles, and a responsive UI. With seamless navigation and a user-friendly interface, V Farer enhances the social experience for travelers, making it easier than ever to document and share their journeys.
...
```bash
git clone https://github.com/rishubajpai007/Vfarer.git
cd Vfarer
```
